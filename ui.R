  ...
  navbarPage(
    ...
    tabPanel(
      ...
      fluidRow(
        column(3, wellPanel(
          ...
          hr(),
          numericInput("lift_prop_test",
            label = "最小可检测相对提升", value = 10,
            min = 0, step = 1
          ),
        ...
        mainPanel(
          tabsetPanel(
            ...
            tabPanel(
              ...
              radioButtons("time_unit_prop_test",
                label = "时间单位",
                choices = list("日", "周", "月", "年"),
                selected = "日", inline = T
              ),
    ...
    tabPanel(
      ...
      fluidRow(
        column(3, wellPanel(
          h4("为你的测试输入合适的参数:"),
          numericInput("sd_t_test",
            label = "标准差", value = 10,
            min = 0, step = 0.1
          ),
          helpText("指标的标准差，从历史数据中分析计算得出。"),
          hr(),
          numericInput("lift_t_test",
            label = "最小可检测绝对提升", value = 0.5,
            min = 0, step = 0.1
          ),
